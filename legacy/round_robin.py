...
def main():
    """
    Main function to test round-robin and random shuffling with different data sizes.
    """
    ...
    for size in sizes:
        ...
        results.append((size, data_size_human_readable, rr_time, rand_time))

    print("\nResults:")
    print("{:<10} {:<15} {:<20} {:<20}".format("Size", "Data Size", "Round-robin Time (s)", "Random Time (s)"))
    for size, data_size_human_readable, rr_time, rand_time in results:
        print("{:<10} {:<15} {:<20.6f} {:<20.6f}".format(size, data_size_human_readable, rr_time, rand_time))
